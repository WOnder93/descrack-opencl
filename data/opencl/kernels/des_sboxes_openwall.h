#ifndef DES_SBOXES_OPENWALL_H
#define DES_SBOXES_OPENWALL_H

/*
 * DES s-boxes adapted from Openwall's John the Ripper.
 *
 * S-BOX 0:  3 versions
 * S-BOX 1:  5 versions
 * S-BOX 2:  6 versions
...
#define vxor(r, a, b) r = v_xor(a, b)
#define vandn(r, a, b) r = v_and(a, v_not(b))
...
#else
#error "Invalid Openwall s-box 1 version configuration!"
#endif // S-BOX 1
...
#else
#error "Invalid Openwall s-box 2 version configuration!"
#endif // S-BOX 2
...
#else
#error "Invalid Openwall s-box 3 version configuration!"
#endif // S-BOX 3
...
#else
#error "Invalid Openwall s-box 4 version configuration!"
#endif // S-BOX 4
...
#else
#error "Invalid Openwall s-box 5 version configuration!"
#endif // S-BOX 5
...
#elif CONFIG_OPENWALL_SBOX_6 == 10
...
#elif CONFIG_OPENWALL_SBOX_6 == 11
...
#elif CONFIG_OPENWALL_SBOX_6 == 12
...
#elif CONFIG_OPENWALL_SBOX_6 == 13
...
#elif CONFIG_OPENWALL_SBOX_6 == 14
...
#else
#error "Invalid Openwall s-box 6 version configuration!"
#endif // S-BOX 6
...
#else
#error "Invalid Openwall s-box 7 version configuration!"
#endif // S-BOX 7
